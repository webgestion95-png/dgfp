        ...
        <div className="container mx-auto grid max-w-6xl gap-12 px-4 md:grid-cols-2 md:items-center">
          ...
          <div id="contact" className="rounded-3xl border border-border bg-background p-8 shadow-card">
            ...
            <ul className="mt-6 space-y-3 text-sm">
              <li className="flex items-center gap-3"><Mail className="h-4 w-4 text-accent" /><a href="mailto:support@dgfp.zenvoriax.com" className="hover:text-accent">support@dgfp.com</a></li>
              <li className="flex items-center gap-3"><Phone className="h-4 w-4 text-accent" /><a href="tel:+447537103065" className="hover:text-accent">+44 7537 103065</a></li>
      ...
      <footer className="border-t border-border bg-card py-10 text-xs text-muted-foreground sm:text-sm">
        <div className="container mx-auto px-4">
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-4">
            <div>
              <p className="font-serif text-base font-medium text-foreground">DGFP BANK</p>
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2">
                ...
                <li><a href="mailto:support_dgfp@nowelio.com" className="hover:text-accent">support@dgfp.com</a></li>
                <li><a href="tel:+447537103065" className="hover:text-accent">+44 7537 103065</a></li>
              </ul>
            </div>
          </div>
          <p className="mt-8 text-center">© {new Date().getFullYear()} DGFP BANK. {t("landing.footer.rights")}</p>
        </div>
      </footer>
    </div>
  );
