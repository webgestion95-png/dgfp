...
import dgfpLogo from "@/assets/dgfp-logo.png";
  ...
  return (
    <div className="container mx-auto px-4 py-6 sm:py-10 max-w-5xl pb-28 lg:pb-10">
      ...
      <div className="flex items-start gap-4 mb-8">
        <img src={dgfpLogo} alt="DGFP BANK" width={56} height={56} className="h-11 w-11 sm:h-14 sm:w-14 rounded-md bg-white p-1 shadow-sm" />
        <div>
          ...
          <CardContent className="space-y-4 text-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a
                  href="https://wa.me/447537103065"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-muted-foreground hover:text-primary hover:underline transition cursor-pointer">+44 7537 103065</a>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a
                 href="mailto:support@dgfp.zenvoriax.com"
                 className="text-muted-foreground hover:text-primary hover:underline transition break-all cursor-pointer">support@dgfp.com</a>
              </div>
            </div>
            <div className="flex items-start gap-3">
