...
const PDF_DICT: Record<Lang, PdfDict> = {
  fr: {
    ...
    docTitle: "Contrat de prêt — DGFP BANK",
    ...
    lenderSig: "Signature du prêteur", lenderName: "DGFP BANK SAS",
    ...
    certificatePrefix: "DGFP BANK-eSign-",
    refPrefix: "Réf.", issuedOn: "Émis le", page: "Page 1 / 1",
    footer: "DGFP BANK SAS · contact@lendly.app · MVP de démonstration",
  ...
  en: {
    ...
    docTitle: "Loan agreement — DGFP BANK",
    ...
    lenderSig: "Lender signature", lenderName: "DGFP BANK SAS",
    ...
    footer: "DGFP BANK SAS · contact@lendly.app · Demo MVP",
  ...
  de: {
    ...
    docTitle: "Darlehensvertrag — DGFP BANK",
    ...
    lenderSig: "Unterschrift des Darlehensgebers", lenderName: "DGFP BANK SAS",
  ...
  es: {
    ...
    docTitle: "Contrato de préstamo — DGFP BANK",
    ...
    lenderSig: "Firma del prestamista", lenderName: "DGFP BANK SAS",
    ...
    footer: "DGFP BANK SAS · contact@lendly.app · MVP demo",
  ...
  it: {
    ...
    docTitle: "Contratto di prestito — DGFP BANK",
    ...
    lenderSig: "Firma del prestatore", lenderName: "DGFP BANK SAS",
  ...
  nl: {
    ...
    docTitle: "Leningsovereenkomst — DGFP BANK",
    ...
    lenderSig: "Handtekening kredietverstrekker", lenderName: "DGFP BANK SAS",
  ...
  sl: {
    ...
    docTitle: "Posojilna pogodba — DGFP BANK",
    ...
    lenderSig: "Podpis posojilodajalca", lenderName: "DGFP BANK SAS",
  ...
  bg: {
    ...
    docTitle: "Договор за заем — DGFP BANK",
    ...
    lenderSig: "Подпис на заемодателя", lenderName: "DGFP BANK SAS",
    ...
    footer: "DGFP BANK SAS · contact@lendly.app · Демо MVP",
  ...
  sk: {
    ...
    docTitle: "Zmluva o úvere — DGFP BANK",
    ...
    lenderSig: "Podpis veriteľa", lenderName: "DGFP BANK SAS",
...
export const generateContractPdf = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data }) => {
    ...
    pdf.setAuthor("DGFP BANK");
    pdf.setCreator("DGFP BANK");
    pdf.setProducer("DGFP BANK Contract Generator");
    ...
    const dgfpRed = rgb(0.85, 0.0, 0.0);
    page.drawRectangle({ x: 0, y: height - 80, width, height: 80, color: rgb(0.98, 0.98, 0.97) });
    const lx = margin, ly = height - 60, ls = 32;
    page.drawRectangle({ x: lx, y: ly, width: ls, height: ls, color: rgb(1, 1, 1), borderColor: dgfpRed, borderWidth: 1 });
    page.drawRectangle({ x: lx, y: ly + ls / 2, width: ls / 2, height: ls / 2, color: dgfpRed });
    page.drawRectangle({ x: lx + ls / 2, y: ly, width: ls / 2, height: ls / 2, color: dgfpRed });
    page.drawText("DGFP BANK", { x: margin + 42, y: height - 47, size: 16, font: helvBold, color: dgfpRed });
    ...
    y -= 22;
    drawKV(page, helv, helvBold, T.lender, sanitize("DGFP BANK SAS - 12 rue de la Finance, 75002 Paris"), margin, y, ink, muted);
    y -= 16;
    ...
    const stampR = 32;
    page.drawCircle({ x: stampCx, y: stampCy, size: stampR, borderColor: dgfpRed, borderWidth: 2, color: rgb(1, 1, 1) });
    page.drawCircle({ x: stampCx, y: stampCy, size: stampR - 4, borderColor: dgfpRed, borderWidth: 0.6, color: rgb(1, 1, 1) });
    const tw = 6;
    page.drawRectangle({ x: stampCx - tw, y: stampCy + 4, width: tw, height: 6, color: dgfpRed });
    page.drawRectangle({ x: stampCx, y: stampCy - 10, width: tw, height: 6, color: dgfpRed });
    page.drawText("DGFP BANK", { x: stampCx - 12, y: stampCy + 14, size: 8, font: helvBold, color: dgfpRed });
    page.drawText("BANK", { x: stampCx - 11, y: stampCy - 22, size: 7, font: helvBold, color: dgfpRed });
    page.drawText("PARIS", { x: stampCx - 11, y: stampCy - 30, size: 6, font: helv, color: dgfpRed });
